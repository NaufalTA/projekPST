...
@section('container')
    <div class="container py-4">
        ...
        <h1 class="pb-3">DASHBOARD | <span class="text-primary">USER</span></h1>

        <div class="d-flex justify-content-end gap-2">

            @if (Auth::user()->role == 'owner')   
            <a href="/companyDashboard/admin" class="btn btn-primary px-3">Admin</a>
            @endif
